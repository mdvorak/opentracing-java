...
public class ThreadLocalScope implements Scope {
    ...
    ThreadLocalScope(ThreadLocalScopeManager scopeManager, Span wrapped, boolean finishOnClose) {
        ...
        scopeManager.listener.onActiveSpanChanged(wrapped);
    }
    ...
    public void close() {
        ...
        if (toRestore != null) {
            ...
            scopeManager.listener.onActiveSpanChanged(toRestore.wrapped);
        } else {
            scopeManager.tlsScope.remove();
            scopeManager.listener.onActiveSpanChanged(null);
        }
    }
